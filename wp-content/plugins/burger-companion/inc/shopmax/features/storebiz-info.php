	 ...
	 */
		...
		class Storebiz_infos_section_upgrade extends WP_Customize_Control {
			...
			<?php }elseif('StoreWise' == $theme->name){ ?>	
				...
				<a class="customizer_storebiz_info_upgrade_section up-to-pro"  href="https://burgerthemes.com/storebiz-pro/" target="_blank" style="display: none;"><?php _e('More Info Available in StoreWise Pro','storebiz'); ?></a>
